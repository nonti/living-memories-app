...
const About = () => {
  return (
    ...
    <div className="gap-16 items-center bg-black/15 rounded-r-lg backdrop-blur-sm  -mt-50 px-2  mx-auto max-w-6xl lg:grid lg:grid-cols-2 lg:py-8 lg:px-4">
        ...
        <div className="grid grid-cols-2 gap-4 mt-8">
            ...
            <img className="mt-4 w-full lg:mt-10 rounded-lg hover:translate-1/2 ease-in-out" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/content/office-long-1.png" alt="office content 2"/>
        </div>
    </div>
</section>
